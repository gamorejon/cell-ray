...
public:
		...
		Intersection& intersection)
    {
		...
		else
		{
			...
			reflectionStart->x = vec_madd(ray->direction.x, 
				intersection.distance, ray->start.x);
			reflectionStart->y = vec_madd(ray->direction.y, 
				intersection.distance, ray->start.y);
			reflectionStart->z = vec_madd(ray->direction.z, 
				intersection.distance, ray->start.z);
